...
from dataset import BilingualDatasetDataset,causal_mask
...
def get_ds(config):
    ...
    subset_ds = ds_raw.select(range(1000))
    ...
    train_ds = BilingualDatasetDataset(train_ds_raw,tokenizer_src,tokenizer_tgt,config['lang_src'],config['lang_tgt'], config['seq_len'])
    val_ds = BilingualDatasetDataset(val_ds_raw,tokenizer_src,tokenizer_tgt,config['lang_src'],config['lang_tgt'], config['seq_len'])
